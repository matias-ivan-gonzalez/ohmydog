...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference("Perro.count") do
      post perros_url, params: { perro: { age: @perro.age, birth_date: @perro.birth_date, breed: @perro.breed, image: @perro.image, name: @perro.name, owner: @perro.owner, weight: @perro.weight } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { age: @perro.age, birth_date: @perro.birth_date, breed: @perro.breed, image: @perro.image, name: @perro.name, owner: @perro.owner, weight: @perro.weight } }
